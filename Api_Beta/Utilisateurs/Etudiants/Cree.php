...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!empty($donnees->centre_etudiant) && !empty($donnees->promotion_etudiant) && !empty($donnees->NOM) && !empty($donnees->PRENOM) && !empty($donnees->Login) && !empty($donnees->Mot_de_passe) && !empty($donnees->ID_Utilisateur__CREE)){
