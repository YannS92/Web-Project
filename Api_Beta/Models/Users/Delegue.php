...
class Delegue {
    ...
    private $table = "delegue";

    // Propriétés
    public $centre_Delegue;
    public $promotions_Delegue;
    public $ID_Utilisateur__CREE;
    public $Droits_Delegue;
    public $ID_Utilisateur__Assigne_DROIT;
   ...
   public function lire(){
    ...
    public function creer(){
        ...
        $sql1 = "INSERT INTO `delegue` (`ID_Utilisateur`, `centre_Delegue`, `promotions_Delegue`, `Droits_Delegue`, `NOM`, `PRENOM`, `Login`, `Mot_de_passe`, `ID_Utilisateur__Assigne_DROIT`, `ID_Utilisateur__CREE`)SELECT ID_Utilisateur,'".$this->centre_Delegue."','".$this->promotions_Delegue."','".$this->Droits_Delegue."',NOM,PRENOM,Login,Mot_de_passe,'".$this->ID_Utilisateur__Assigne_DROIT."','".$this->ID_Utilisateur__CREE."' FROM ".$this->tableUtilisateur." WHERE NOM = '".$this->NOM."' && PRENOM = '".$this->PRENOM."' && Login='".$this->Login."' && Mot_de_passe = '".$this->Mot_de_passe."'";
        ...
        $this->promotions_Delegue=htmlspecialchars(strip_tags($this->promotions_Delegue));
        $this->Droits_Delegue=htmlspecialchars(strip_tags($this->Droits_Delegue));
    ...
    public function modifier(){
        // On écrit la requête
        $sql = "UPDATE ".$this->table."  SET centre_Delegue= '".$this->centre_Delegue."', promotions_Delegue= '".$this->promotions_Delegue."', Droits_Delegue = '".$this->Droits_Delegue."', NOM = '".$this->NOM."', PRENOM = '".$this->PRENOM."', Login = '".$this->Login."' , Mot_de_passe = '".$this->Mot_de_passe."', Id_Utilisateur__CREE='".$this->ID_Utilisateur__CREE."', ID_Utilisateur__Assigne_DROIT = '".$this->ID_Utilisateur__Assigne_DROIT."' WHERE ID_Utilisateur = '".$this->ID_Utilisateur."'";
